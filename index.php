...
$assets = [
    'scripts' => [
        ...
        'jquery' => $cdn . '/' . 'jquery/3.1.1/jquery.min.js',
        'respond' => $cdn . '/' . 'respond.js/1.4.2/respond.min.js',
        'toastr' => $cdn . '/' . 'toastr.js/2.1.3/toastr.min.js',
    ],
    'styles' => [
        'font-awesome' => $cdn . '/' .
                          'font-awesome/4.7.0/css/font-awesome.min.css',
        'normalize' => $cdn . '/' . 'normalize/5.0.0/normalize.min.css',
        'toastr' => $cdn . '/' . 'toastr.js/2.1.3/toastr.min.css',
    ],
];
...
$viewport = 'initial-scale=1, maximum-scale=1, user-scal' .
            'able=no, width=device-width';
